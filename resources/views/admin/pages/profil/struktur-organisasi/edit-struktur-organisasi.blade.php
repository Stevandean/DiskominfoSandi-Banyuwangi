...
<div class="md:shadow-md bg-white rounded-lg p-3 pt-4">
  ...
  <form id="form-upload" class="p-5" action="/admin/layanan" method="post" enctype="multipart/form-data"> 
    ...
    @csrf
    <div class="mb-5">
      <x-admin.input-upload infoFileReadOnly="{!! $imgStrukturOrganisasi !!}"  type="image" input-name="img struktur organisasi" form-name="imgStrukturOrganisasi" :is-filled=true :is-error=false >
