...
<div class="md:shadow-md bg-white rounded-lg p-3 pt-4">
  <div class="flex flex-wrap md:flex-nowrap gap-3 justify-between items-center p-4 pt-1">
    <a href="/admin/profil/visi-misi" class="font-bold text-xl text-blue-kominfo inline-flex items-center">
      <svg 
  ...
  <form id="form-upload" class="p-5" action="/admin/layanan" method="post" enctype="multipart/form-data"> 
    ...
    @csrf
    <div class="mb-5">
        <x-admin.input form-name="visi" input-name="Visi" input-value="{{ $visi }}" />
    </div>
    <div class="mb-5">
        <x-admin.input form-name="misi" input-name="Misi" input-value="{{ $misi }}" />
    </div>
    <div class="mb-6">
