...
@section('container')
  ...
  <div class="shadow-md bg-white rounded-lg p-3 pt-4">
    <div class="flex flex-wrap md:flex-nowrap gap-3 justify-between items-center p-4 pt-1">
      ...
      <a href="/admin/profil/visi-misi/edit" class="text-sm bg-blue-700 hover:bg-blue-800 text-white focus:ring-4 focus:ring-blue-300 py-2 px-8 rounded-md w-full sm:w-auto">
    ...
    <div class="overflow-x-auto relative">
        <div class="pair p-3 mb-3">
            ...
            <p class="bg-blue-100 p-2 rounded-md">{{ $visi }}</p>
        </div>
        <div class="pair p-3 mb-3">
            <h3 class="font-bold mb-2">Misi</h3>
            <p class="bg-blue-100 p-2 rounded-md">{{ $misi }}</p>
        </div>
    </div>
  </div>
@endsection
