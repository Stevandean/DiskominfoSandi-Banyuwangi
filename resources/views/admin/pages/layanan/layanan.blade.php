...
@section('container')
  <div class="flex justify-between flex-wrap xl:flex-nowrap gap-2 mb-7">
    <!-- tool bar-->
    <x-admin.search-input inputValue="{{ request('search') }}" />
    <div class="mx-auto xl:mx-0"> 
      <!-- untuk pagination -->
      {{ $service->links('vendor.pagination.admin-pagination') }}
    </div>
  </div>
  <!--akhir toolbar-->
  ...
  <div class="shadow-md bg-white rounded-lg p-3 pt-4">
    ...
    @if(request('type') && request('search'))
      ...
      @endif
        <span class="text-blue-900 bg-blue-300 text-lg font-normal px-7 rounded-2xl">{{ $serviceCount }} item</span>
      </span>
      <!-- end info data -->


      <a href="/admin/layanan/create" class="text-sm bg-blue-700 hover:bg-blue-800 text-white focus:ring-4 focus:ring-blue-300 py-2 px-8 rounded-md w-full sm:w-auto">
        ...
        <tbody>
          ...
          <tr class="bg-white border-b">
            ...
            <td class="py-4 px-6">
              <div class="inline-flex">
                <!-- delete -->
                <button class="btn-delete btn-s inline-block rounded-full bg-red-200 hover:bg-red-400 p-2 hover:fill-white mx-1 active:ring-2 active:ring-red-300 transition-all" data-id="{{ $service -> id }}">
                  <svg 
                    class=" fill-red-700 "
                    fill="#000000" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" height="20px"><path d="M 6.496094 1 C 5.675781 1 5 1.675781 5 2.496094 L 5 3 L 2 3 L 2 4 L 3 4 L 3 12.5 C 3 13.324219 3.675781 14 4.5 14 L 10.5 14 C 11.324219 14 12 13.324219 12 12.5 L 12 4 L 13 4 L 13 3 L 10 3 L 10 2.496094 C 10 1.675781 9.324219 1 8.503906 1 Z M 6.496094 2 L 8.503906 2 C 8.785156 2 9 2.214844 9 2.496094 L 9 3 L 6 3 L 6 2.496094 C 6 2.214844 6.214844 2 6.496094 2 Z M 4 4 L 11 4 L 11 12.5 C 11 12.78125 10.78125 13 10.5 13 L 4.5 13 C 4.21875 13 4 12.78125 4 12.5 Z M 5 5 L 5 12 L 6 12 L 6 5 Z M 7 5 L 7 12 L 8 12 L 8 5 Z M 9 5 L 9 12 L 10 12 L 10 5 Z" />
                  </svg>
                ...
                <!-- ini untuk icon edit -->
                <a href="/admin/layanan/{{ $service->id }}/edit"class="btn-s inline-block rounded-full bg-amber-200 hover:bg-amber-400 p-2 hover:fill-white mx-1 active:ring-2 active:ring-amber-300 transition-all">
                  <svg
                    class="fill-amber-700"
                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 24 24" height="20px">
                    <g id="surface125014719">
                ...
                <!-- ini untuk icon views -->
                <button class="btn-s inline-block rounded-full bg-green-200 hover:bg-green-400 p-2 hover:fill-white mx-1 active:ring-2 active:ring-green-300 transition-all">
                  <svg 
                    class="stroke-green-700 "
                    height="20px" width="20px"
                    viewBox="0 0 80 51" fill="none" xmlns="http://www.w3.org/2000/svg">
