...
@section('container')
  ...
  <div class="md:shadow-md bg-white rounded-lg p-3 pt-4">
    ...
    <hr>
    <form class="p-5" action="/admin/berita/{{ $news -> id }}" method="post" enctype="multipart/form-data">
      @method ('PUT')
      @csrf
      ...
      <div class="mb-6">
        ...
        <input type="text" id="title" name="title" class="bg-gray-50 border border-gray-300  text-gray-900 text-sm rounded-lg focus-within:ring-blue-500 focus-within:outline-blue-500 focus:border-blue-500 block w-full p-2.5 " required value="{{ $news -> title }}">
        <!-- pesar error -->
      ...
      <div class="mb-6">
        ...
        <input type="text" id="slug" name="slug" class="bg-gray-50 border border-gray-300  text-gray-900 text-sm rounded-lg focus-within:ring-blue-500 focus-within:outline-blue-500 focus:border-blue-500 block w-full p-2.5 " required value="{{ $news -> slug }}">
        <!-- pesar error -->
        <p id="filled_error_help" class=" hidden mt-2 text-xs text-red-600"><span class="font-medium">Oh, snapp!</span> Some error message.</p>
        <!-- akhir pesar error -->
      </div>
      ...
      <div class="mb-6">
        ...
        <input type="hidden" name="body" id="body" value="{{ $news -> body }}">
