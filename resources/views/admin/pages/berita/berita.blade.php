  ...
  <div class="flex justify-between flex-wrap xl:flex-nowrap gap-2 mb-7"> 
    ...
    <x-admin.search-input-dropdown inputValue="{{ request('search') }}" >
      <select id="type" name="type" class="sm:basis-1/3 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ">
        ...
        <option value="goverment" @selected(request('goverment') == 'goverment')>goverment</option>
        <option value="technology" @selected(request('type') == 'technology')>technology</option>
  ...
  <div class="shadow-md bg-white rounded-lg p-3 pt-4">
    <div class="flex flex-wrap md:flex-nowrap gap-3 justify-between items-center p-4 pt-1">
      ...
      <!-- Akhir Search -->
        ...
        <span class="text-blue-900 bg-blue-300 text-lg font-normal px-7 rounded-2xl">
          {{ $newsCount }} item
        </span>
      </span>
      ...
      <table class="w-full text-sm text-left text-gray-500">
        ...
        <tbody>
          <tr class="bg-white border-b">
            ...
            <td class="py-4 px-6">
              <span class="bg-amber-200 rounded-full px-8 py-0.5 border border-amber-600 text-amber-900">
                Berita
              </span>
              <span class=" hidden bg-lime-200 rounded-full px-8 py-0.5 border border-lime-600 text-lime-900">
                Goverment
              </span>
              <span class=" hidden bg-sky-200 rounded-full px-8 py-0.5 border border-sky-600 text-sky-900">
                Technology
              </span>
            </td>
          ...
          <tr class="bg-white border-b">
            ...
            <td class="py-4 px-6 ">
              <img class="w-24" src="{{ asset('/storage/'.$news -> image) }} " alt="">
            </td>
            <td class="py-4 px-6 font-medium text-gray-900 max-w-md">
              {{ $news->title }}
            </td>
            <td class="py-4 px-6">
              @php
            ...
            <td class="py-4 px-6">
              <div class="inline-flex">
                <!-- delete -->
                <button class="btn-delete btn-s inline-block rounded-full bg-red-200 hover:bg-red-400 p-2 hover:fill-white mx-1 active:ring-2 active:ring-red-300 transition-all" data-id="{{ $news -> id }}">
                  <svg 
                    class=" fill-red-700 "
                    fill="#000000" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" height="20px"><path d="M 6.496094 1 C 5.675781 1 5 1.675781 5 2.496094 L 5 3 L 2 3 L 2 4 L 3 4 L 3 12.5 C 3 13.324219 3.675781 14 4.5 14 L 10.5 14 C 11.324219 14 12 13.324219 12 12.5 L 12 4 L 13 4 L 13 3 L 10 3 L 10 2.496094 C 10 1.675781 9.324219 1 8.503906 1 Z M 6.496094 2 L 8.503906 2 C 8.785156 2 9 2.214844 9 2.496094 L 9 3 L 6 3 L 6 2.496094 C 6 2.214844 6.214844 2 6.496094 2 Z M 4 4 L 11 4 L 11 12.5 C 11 12.78125 10.78125 13 10.5 13 L 4.5 13 C 4.21875 13 4 12.78125 4 12.5 Z M 5 5 L 5 12 L 6 12 L 6 5 Z M 7 5 L 7 12 L 8 12 L 8 5 Z M 9 5 L 9 12 L 10 12 L 10 5 Z" />
                  </svg>
