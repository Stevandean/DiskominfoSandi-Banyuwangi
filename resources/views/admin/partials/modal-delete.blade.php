...
@push('add-script')
    <script>
        ...
        closeModal.forEach(el => el.addEventListener('click', (e) => toggleModal()));
        deleteModal.addEventListener('click', (e) => e.target == e.currentTarget ? toggleModal() : false)
        btnDelete.forEach(elm => {
            elm.addEventListener('click', function(e){
                formModal.setAttribute('action', url+'/'+this.getAttribute('data-id'));
                toggleModal();
            })
        });

        //--------- untuk menangani delete data ---------
