        ...
        <div class="relative bg-white rounded-lg shadow">
            ...
            <div class="p-6 space-y-3">
                <div class="flex flex-wrap">
                    ...
                    <p class="text-base leading-relaxed break-all mx-2">
                        Eum ipsa aut sed repudiandae quibusdam esse.
                    </p>
                </div>
                <div class="flex flex-wrap">
                    <p class="text-base leading-relaxed font-semibold">
                    ...
                    <p class="text-base leading-relaxed break-all mx-2">
                        Eum ipsa aut sed repudiandae quibusdam esseEum ipsa aut sed repudiandae quibusdam esseEum ipsa aut sed repudiandae quibusdam esse.
                    </p>
                </div>
                <div class="flex flex-wrap">
                    <p class="text-base leading-relaxed font-semibold">
                    ...
                    <p class="text-base leading-relaxed break-all mx-2">
                        https://ini-adalah-domain/sub-1/sub-2/index.php
                    </p>
                </div>
                <div class="flex flex-wrap">
                    <p class="text-base leading-relaxed font-semibold">
                    ...
                    <p class="text-base  leading-relaxed bg-[#FFF5BE] rounded-full px-3 mx-2">
                        19 - july - 2022
                    </p>
                </div>
            </div>
