...
<!-- ** AWAL PELAYANAN ** -->
    <div class="p-4 px-5 pb-40 pt-20 bg-gray-100">
      ...
      <div class="flex flex-wrap justify-center gap-6 md:gap-6 xl:gap-8">
        ...
        <!-- card -->
        <a href="/layanan" class="relative group block p-6  max-w-sm bg-gradient-to-r from-[#ebf4f5] to-[#b5c6e0]  rounded-lg border border-gray-200 shadow-md">
          ...
          <p class="font-normal text-gray-700 text-base">Here are the biggest enterprise technology acquisitions of 2021 so far, in reverse chronological order.</p>
        </a>
        <!-- end card -->
    ...
    <div class="px-20 pb-40 pt-10 ">
      ...
      <div class="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
        ...
        <!-- card -->
        <a href"http://sikd.banyuwangikab.go.id/" class="relative group block mx-auto p-6 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md bg-gradient-to-r from-[#ebf4f5] to-[#b5c6e0]">
          <div class="flex">
