...
@section ('container')
    ...
    <div class="px-4 pb-8">
        ...
        <div class="text-md w-3/4 m-auto">
            ...
            <div id="default-carousel" class="relative" data-carousel="static">
                <!-- Carousel wrapper -->
                <div class="overflow-hidden relative rounded-lg h-20 w-3/4 m-auto">
                        <a class="hidden duration-700 ease-in-out" data-carousel-item>
                            <span class="z-20 absolute bottom-10 left-10 text-xl lg:text-2xl font-semibold text-white">Title</span>
                            ...
                            <div class="bg-white block absolute top-1/2 left-1/2 w-full min-h-full -translate-x-1/2 -translate-y-1/2">
                                <img class="float-left w-full mr-5" src="/images/3554-IMG-20170303-WA0004.jpg">
            ...
            <img class="float-left w-40 h-56 mr-5" src="/images/3554-IMG-20170303-WA0004.jpg">
